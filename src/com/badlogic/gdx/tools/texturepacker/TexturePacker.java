...
import static com.badlogic.gdx.tools.texturepacker.MultiTexturePacker.*;
...
public class TexturePacker {
	...
	static public void process (Settings settings, String input, String output, String packFileName,
		...
		try {
			TextureBasicPackerFileProcessor processor = new TextureBasicPackerFileProcessor(settings, packFileName);
	...
	static public void main (String[] args) throws Exception {
		...
		processIfModified(settings, input, output, packFileName);
	}
}
